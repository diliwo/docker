<h1>Liste des mutations non-traitées</h1>
        ...
        foreach($mutations as $mutation)
        {
            ?>
                <tr>
                    ...
                    <td style='vertical-align:middle;' id="verifie_<?php echo $mutation->donnees["ID_MUTATION"] ?>"><?php echo ($mutation->donnees["VERIFIE"] ? "Oui" : "Non<br><input type='button' value='vérifié' onclick='verifier(".$mutation->donnees["ID_MUTATION"].")'/> "); ?></td>
                    <td style='vertical-align:middle;' id="traite_<?php echo $mutation->donnees["ID_MUTATION"] ?>"><?php echo ($mutation->donnees["TRAITE"] ? "Oui"   : "Non<br><input type='button' value='traité'  onclick ='traiter(".$mutation->donnees["ID_MUTATION"].")'/> "); ?></td>
