...
if (isset($_GET["registre_national"])) {
	...
	// Pour les CPAS, uniquement NET_INCOME
	$donneeDemandee = "NET_INCOME";
	...
	$arguments = array(
		...
		"searchCriteria" => array(
			"ssin" => $rn,
			"taxAssessmentDataSelection" => $donneeDemandee
		)
	);
	...
	$wsdl = "http://" . $_SERVER["HTTP_HOST"] . str_replace("index.php", "", $_SERVER["PHP_SELF"]) . "../../../../include/soap/taxi_as/v1/".$env."/TaxAssessmentDataV1.wsdl";
	...
	try {
	    ...
	    $retour["data"] = $soapClient->getTaxAssessmentData($arguments);
