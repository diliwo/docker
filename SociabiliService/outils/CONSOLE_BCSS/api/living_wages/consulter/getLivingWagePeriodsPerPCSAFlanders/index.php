...
if (isset($_GET["registre_national"])) {
    ...
    if (isset($_GET["username"]))
        ...
        if (isset($_GET["password"]))
            ...
            $wsdl = absolutePath('include/soap/living_wages/'.$env.'/LivingWagesWsdl/LivingWagesV2.wsdl');
    ...
    try {
        ...
        $retour["data"] = $soapClient->getLivingWagePeriodsPerPCSAFlanders($arguments);
