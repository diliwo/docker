...
if (isset($_GET["registre_national"])) {
	...
	$restrictionRecherche = 0;
	if ((isset($_GET["restriction_recherche"])) && (!empty($_GET["restriction_recherche"]))) {
		$restrictionRecherche = $_GET['restriction_recherche'];
	}
    ...
    $arguments = array(
        ...
        "searchCriteria" => array(
            ...
            "allAllowance" => $restrictionRecherche
        )
    );
    ...
    try {
        ...
        $retour["data"] = $soapClient->consultPaidSums($arguments);
