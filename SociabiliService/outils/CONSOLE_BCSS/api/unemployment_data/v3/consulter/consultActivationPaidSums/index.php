...
if (isset($_GET["registre_national"])) {
	...
	$allAllowance = 1;
	if ((isset($_GET["allAllowance"])) && (is_numeric($_GET["allAllowance"]))) {
	    $allAllowance = $_GET['allAllowance'];
	}
    ...
    try {
        ...
        $retour["data"] = $soapClient->consultActivationPaidSums($arguments);
