			...
			try {
				...
				if ($codeErreur > 1) {
					...
					if (isset($listeAttestationsXml->ExonerationArt35)) {
						$retour['data']['result']['ExonerationArt35']['FirstExonerationDate'] = (string) $listeAttestationsXml->ExonerationArt35->FirstExonerationDate[0];
						$retour['data']['result']['ExonerationArt35']['PaymentExoneratedDays'] = (int) $listeAttestationsXml->ExonerationArt35->PaymentExoneratedDays[0];
					}
					$retour['data']['result']['Attestation'] = array();
