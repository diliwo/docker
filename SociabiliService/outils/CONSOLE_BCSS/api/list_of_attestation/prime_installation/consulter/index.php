		...
		try {
			...
			$arguments .
				"<ServiceRequest>" .
					...
					"<ns1:ListOfAttestationsRequest xmlns:ns1='http://www.ksz-bcss.fgov.be/XSD/SSDN/OCMW_CPAS/ManageAttests' xmlns:ns2='http://www.ksz-bcss.fgov.be/XSD/SSDN/Common'>" .
						...
						"<ns1:RequestType>PRIME_INSTALLATION</ns1:RequestType>" .
						"<ns1:SearchPeriod>" .
			...
			try {
				...
				if ($codeErreur > 1) {
					...
					if (count($listeAttestationsXml->Attestation) > 0) {
						...
						$retour['data']['status']['description'] = "La personne est connue mais il n'existe pas de PI";
