...
if (isset($_GET["registre_national"]) && isset($_GET["numero_bce"])) {
	// Récupération et génération des arguments
	$rn = $_GET["registre_national"];
	$numeroBce = $_GET["numero_bce"];
			...
			$arguments .
				"<ServiceRequest>" .
					...
					"<ns1:ListOfAttestationsRequest xmlns:ns1='http://www.ksz-bcss.fgov.be/XSD/SSDN/OCMW_CPAS/ManageAttests' xmlns:ns2='http://www.ksz-bcss.fgov.be/XSD/SSDN/Common'>" .
						...
						"<ns1:KBOBCE>" . $numeroBce . "</ns1:KBOBCE>" .
						"<ns1:RequestType>FORMULAIRES</ns1:RequestType>" .
						"<ns1:SearchPeriod>" .
	...
	$retour["message"] = "Le registre national et/ou le numéro BCE n'est pas encodé";
