...
$("#transaction25 form").validate({
	...
	submitHandler: function(form) {
		...
		if (RegistreNational.valider( rn )) {
			var url = "<?php echo $_CONFIG['url']; ?>api/transaction25/v1/consulter?env=<?php echo $_SESSION['test_flux_bcss']['env']; ?>&registre_national=" + rn + "&langue=" + langue + "&historicite=" + historicite;
