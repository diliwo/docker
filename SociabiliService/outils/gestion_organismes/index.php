...
oci_execute($stid);
oci_fetch_all($stid, $types_organisme, 0, -1, OCI_FETCHSTATEMENT_BY_ROW + OCI_ASSOC);
...
<head>
    <meta charset="UTF-8">
    <title>Listing | Gestion des organismes (Helpdesk Social)</title>
...
<body style="padding-top: 70px;">    
            ...
            <form id="frmAjax" class="col-lg-4">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                       <?php foreach ($types_organisme as $type_organisme): ?>
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" name="type[]" value="<?php echo $type_organisme['ID_ORGANISME_TYPE']; ?>">
                                    <?php echo $type_organisme['LIBELLE']; ?>
                                </label>
                            </div>
                        <?php endforeach; ?>
    ...
    <script>
        $(function(){
            function ajaxSelect() {
                $.cookie('organismes', $('#frmAjax').serialize());
            ...
            function reloadFilters() {
                var filtres = $.cookie('organismes');

                if (filtres !== undefined && filtres !== null) {
                    $('#frmAjax').unserializeForm($.cookie('organismes'));
                } else {
