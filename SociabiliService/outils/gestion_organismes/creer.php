...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    if (empty($values['organisme']) || empty($values['rue']) || empty($values['numero']) || empty($values['id_code_postaux']) || empty($values['type'])) {
        ...
        $sqlt = "INSERT INTO SSC_ORGANISME (ORGANISME, ID_ADRESSE, ID_ORGANISME_TYPE, ACTIVE) VALUES (:organisme, :id_adresse, :id_organisme_type, :active)";
        $stid = oci_parse($conn, $sqlt);
...
<head>
    <meta charset="UTF-8">
    <title>Créer un organisme | Gestion des organismes (Helpdesk Social)</title>
    ...
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">Créer un organisme</h3>
            </div>
