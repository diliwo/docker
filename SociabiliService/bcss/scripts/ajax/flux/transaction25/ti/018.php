    ...
    <table>
        <tbody>
        	...
        	<tr>
        		<th>Adresse : </th>
        		<td>
        		<?php echo (isset($ti->Address->Country))?$ti->Address->Country->Label . "<br />":""; ?>
        		<?php echo (isset($ti->Graphic1))?$ti->Graphic1 ."<br />":""; ?>
        		<?php echo (isset($ti->Graphic2))?$ti->Graphic2 ."<br />":""; ?>
        		<?php echo (isset($ti->Graphic3))?$ti->Graphic3 ."<br />":""; ?>
        		</td>
        	</tr>
