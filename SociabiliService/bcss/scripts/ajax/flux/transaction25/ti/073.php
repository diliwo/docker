...
<div class="fieldset">
	...
	<table>
		<tbody>
			...
			<?php if (isset($ti->Category)): ?>
			<tr>
				<th>Catégorie : </th>
				<td><?php echo $ti->Category->Label; ?></td>
			</tr>
			<?php endif; ?>
			
			<?php if (isset($ti->CertificateNumber)): ?>
			<tr>
				<th>Numéro du certificat : </th>
				<td><?php echo $ti->CertificateNumber; ?></td>
			</tr>
			<?php endif; ?>
