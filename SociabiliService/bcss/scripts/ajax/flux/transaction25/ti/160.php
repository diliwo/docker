...
<div class="fieldset">
	...
	<table>
		<tbody>
			...
			<?php if (isset($ti->Situation)): ?>
			<tr>
				<th>Situation : </th>
				<td><?php echo $ti->Situation->Label; ?></td>
			</tr>
			<?php endif; ?>
			...
			<?php if (isset($ti->Class)): ?>
			<tr>
				<th>Classe - année : </th>
				<td><?php echo $ti->Class->Year; ?></td>
			</tr>
			
				<?php if (isset($ti->Class->Qualification)): ?>
				<tr>
					<th>Classe - qualification : </th>
					<td><?php echo $ti->Class->Qualification; ?></td>
				</tr>
				<?php endif; ?>
