...
<div class="fieldset">
	...
	<table>
		<tbody>
			...
			<?php if (isset($ti->SocialWelfare)): ?>
			<tr>
				<th>Etablissement de la sécurité sociale : </th>
				<td><?php echo $ti->SocialWelfare->Place->Label; ?><?php echo (isset($ti->SocialWelfare->Initiative))?" (" . $ti->SocialWelfare->Initiative->Label . ")":""; ?></td>
			</tr>
			<?php elseif (isset($ti->RefugeeCentre)): ?>
			<tr>
				<th>Centre de réfugiés : </th>
				<td><?php echo $ti->RefugeeCentre->Label; ?></td>
			</tr>
			<?php endif; ?>
